(function(){
    ...
    function photoUpload() {
        return {
            ...
            '   </select>' +
            '   <button class="btn btn-success" ng-disabled="vm.baned" ngf-select="vm.openPhotos($files, $invalidFiles)" ngf-multiple="true" accept="image/*" ngf-max-height="6000" ngf-max-size="10MB">' +
            '       Select {{ vm.btnText }}' +
            '   </button>' +
            '   <button class="btn btn-success" ng-disabled="vm.baned" ng-click="vm.uploadPhotos(vm.photos, vm.albumId)"> Upload {{ vm.btnText }}</button>' +
